...
from src.ingestion.utils.test_zip.ingestion_lambda_handler import (
...
@patch(
    "src.ingestion.utils.test_zip.ingestion_lambda_handler.add_ts_for_processing_bucket"
)
@patch(
    "src.ingestion.utils.test_zip.ingestion_lambda_handler.query_updated_table_information"
)
@patch(
    "src.ingestion.utils.test_zip.ingestion_lambda_handler.convert_datetimes_and_decimals"
)
